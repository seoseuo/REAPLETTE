                ...
                <div class="login-box">
                    ...
                    <form id="verify-form" class="w-100" action="/signup/setPassword" method="get">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="id" value="${sessionScope.id != null ? sessionScope.id : ''}" readonly disabled>
                             <!-- 인증번호 발송 메시지를 표시할 공간 -->
                            <input type="hidden" id="verificationCode" value="${sessionScope.verificationCode != null ? sessionScope.verificationCode : ''}">
